...
const myCircles = [
  {
    id: 1,
    name: "Alpha Domains",
    description: "Premium domain investment circle focusing on .eth and .com domains",
    members: 24,
      ...
      <Layout>
        <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
          <div className="flex items-center justify-between space-y-2">
            <div>
              <h2 className="text-3xl font-bold tracking-tight">Investment Circles</h2>
          ...
          <Card className="col-span-full">
            <CardHeader className="pb-3">
              <CardTitle>Join Investment Circles</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <div className="space-y-4">
                <h3 className="font-semibold">What are Investment Circles?</h3>
                ...
                <Button className="mt-4">Connect Wallet to Continue</Button>
              </div>
            </CardContent>
          </Card>
        </div>
  ...
  return (
    <Layout>
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        {/* My Circles */}
        <div className="space-y-4">
          <h3 className="text-xl font-semibold">My Circles</h3>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {myCircles.map((circle) => (
              <Card key={circle.id} className="cursor-pointer hover:shadow-lg transition-shadow">
                <CardHeader className="pb-3">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2 border-t">
                    <div>
                      ...
                      <p className="font-semibold">{circle.totalInvested}</p>
                    </div>
                    <div>
                      <p className="text-xs text-muted-foreground">Monthly Return</p>
                      <p className="font-semibold text-green-600">{circle.monthlyReturn}</p>
                    </div>
                  </div>
        ...
        {/* Available Circles */}
        <div className="space-y-4">
          <h3 className="text-xl font-semibold">Available Circles</h3>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Circles Joined</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Admin Circles</p>
